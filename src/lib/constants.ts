...
export const PROMOTIONS: Promotion[] = [
  {
    ...
    altEn: "Complete checkup for men promotion for $89 with urine, prostate and testosterone tests at Clínica Hispana Cruz #3 Houston",
    highlighted: true,
    order: 1,
  },
  {
    ...
    alt: "Promoción de chequeo completo de mujer por $79 con Papanicolaou, consulta ginecológica y orden de mamografía en Clínica Hispana Cruz #3 Houston",
    altEn: "Complete women's checkup promotion for $79 with Pap smear, gynecological consultation and mammogram order at Clínica Hispana Cruz #3 Houston",
    highlighted: true,
    order: 2,
  },
  {
    ...
    alt: "Promoción de examen general de sangre más inyección de Vitamina B12 por $99 en Clínica Hispana Cruz #3 Houston",
    altEn: "General blood test plus Vitamin B12 injection promotion for $99 at Clínica Hispana Cruz #3 Houston",
    order: 3,
  },
  {
    ...
    alt: "Promoción de salud íntima femenina por $69 con cultivo íntimo, consulta médica y examen de orina en Clínica Hispana Cruz #3 Houston",
    altEn: "Women's intimate health promotion for $69 with intimate culture test, medical consultation and urine test at Clínica Hispana Cruz #3 Houston",
    order: 4,
  },
  {
    ...
    alt: "Promoción de perfil hormonal masculino por $200 en Clínica Hispana Cruz #3 Houston",
    altEn: "Male hormone profile promotion for $200 at Clínica Hispana Cruz #3 Houston",
    order: 5,
  },
  {
    ...
    alt: "Promoción de diagnóstico completo de enfermedades de transmisión sexual por $249 en Clínica Hispana Cruz #3 Houston",
    altEn: "Complete sexually transmitted disease diagnosis promotion for $249 at Clínica Hispana Cruz #3 Houston",
    order: 6,
  },
  {
    slug: "examen-dot",
    ...
    alt: "Promoción de examen médico DOT para conductores comerciales con certificación oficial en Clínica Hispana Cruz #3 Houston",
    altEn: "DOT medical exam promotion for commercial drivers with official certification at Clínica Hispana Cruz #3 Houston",
    order: 7,
  },
];
